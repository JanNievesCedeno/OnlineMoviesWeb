            ...
            <section class="library-flex-container">
                <?php
                    if (isset($_SESSION['username'])) {
                        ...
                        // Single optimized query with JOINs - much more efficient than N+1 queries
                        $stmt = $conex->prepare("SELECT m.movie_name, m.movie_picture, m.movie_genre, m.movie_year 
                                                 FROM sales s
